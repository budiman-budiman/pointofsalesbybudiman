...
<div class="wrapper">
  <header class="main-header">
    <a href="<?=base_url('dashboard')?>" class="logo"> 
      <span class="logo-mini"><b>Toko</b>134</span>
      <span class="logo-lg"><b>Toko </b>134</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/dist/img/profil.jpeg" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?=$this->uri->segment(1) == 'dashboard' || $this->uri->segment(1) == '' ? 'class="active"' : ''?>>
              <a href="<?=site_url('dashboard')?>"><i class="fa fa-dashboard"><span></i>Dashboard</span></a>
            </li>
            <li <?=$this->uri->segment(1) == 'supplier' ? 'class="active"' : ''?>>
              <a href="<?=site_url('supplier')?>"><i class="fa fa-truck"><span></i>Suppliers</span></a>
            </li>
            <li <?=$this->uri->segment(1) == 'customer' ? 'class="active"' : ''?>>
              <a href="<?=site_url('customer')?>"><i class="fa fa-users"><span></i>Customers</span></a>
            </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=$this->uri->segment(1) == 'sale' ? 'class="active"' : ''?>"><a href="<?=site_url('sale')?>"><i class="fa fa-circle-o"></i> Sales</a></li>
            <li><a href="<?=$this->uri->segment(1) == 'stock_in' ? 'class="active"' : ''?>"><a href="<?=site_url('stock/in')?>"><i class="fa fa-circle-o"></i> Stock In</a></li>
            <li><a href="<?=$this->uri->segment(1) == 'stock_out' ? 'class="active"' : ''?>"><a href="<?=site_url('stock/out')?>"><i class="fa fa-circle-o"></i> Stock Out</a></li>
  ...
  <footer class="main-footer">
    ...
    Point of sales menggunakan framework Codeigniter
  </footer>
